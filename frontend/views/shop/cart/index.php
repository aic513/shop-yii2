                    ...
                    <td class="text-left">
                        ...
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <span class="input-group-btn">
                                    ...
                                    <a title="Remove" class="btn btn-danger" href="<?= Url::to(['remove', 'id' => $item->getId()]) ?>" data-method="post"><i
    ...
    <div class="buttons clearfix">
        ...
        <?php if ($cart->getItems()): ?>
            <div class="pull-right">
                <a href="<?= Url::to('/shop/checkout/index') ?>" class="btn btn-primary">Checkout</a>
            </div>
        <?php endif; ?>
    </div>
</div>